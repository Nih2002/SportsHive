...
<div class="col-span-3 max-w-7xl mx-auto py-12 px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php
          ...
          $sql = "SELECT id, name, image_url, item_type, sizes, colors, stock_status, description, price FROM swimming WHERE item_type = 'protection'";
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Colors Section
                    ...
                    echo '<li>
                        <button class="w-6 h-6 rounded-full hover:ring-2 hover:ring-red-300" 
