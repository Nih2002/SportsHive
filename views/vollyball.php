  ...
  <div class="h-96 bg-cover bg-center" style="background-image: url('../images/sportsback1.jpg');">
    <body class="bg-gray-100">
            <div class="flex flex-col md:flex-row items-center justify-center h-96">
                <!-- Text Section -->
                <div class="flex flex-col p-6 bg-white shadow-lg justify-start">
                <h1 class="text-3xl font-bold text-gray-800 leading-tight">Volleyball</h1>
                <div class="w-12 h-1 bg-lime-400 my-4"></div>
                <p class="text-gray-600 mb-4">Empower your game, elevate your performance – Equip yourself with the best for the court.</p>
                </div>
